  ...
  return (
    <div className="sm:w-3/5 mx-auto my-20 ">
      <div className="flex flex-col gap-10 items-center sm:flex-row sm:justify-evenly px-10 sm:px-0 ">
        <div className="sm:w-1/2">
          ...
          <p className="my-5 text-slate-700 font-robo leading-8 font-semibold">
            I&apos;m Andy Nguyen, a passionate front-end React developer with a
            keen eye for creating engaging and dynamic user interfaces.
          </p>
        </div>
      ...
      <div className="flex items-center sm:justify-center mt-20">
        ...
        <div className="w-full sm:w-5/12 flex flex-row overflow-hidden after:absolute after:bg-gradient-to-r  after:w-10 after:h-[50px] after:right-0  before:absolute before:bg-gradient-to-l from-transparent to-white before:z-10 before:w-10 before:h-[50px] before:left-15 sm:after:content-none sm:before:content-none">
